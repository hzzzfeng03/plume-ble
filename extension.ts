...
namespace blockytalky {
    ...
    */
     ...
     * @param value 
     */
    //% blockid="blockytalky_sendnumber" block="BLE发送数字 $key 和 $value"
     ...
     * @param value 
     */
    //% blockid="blockytalky_sendnumber" block="BLE发送字符串 $key 和 $value"
    ...
    //% blockId=blockytalky_on_number block="BLE接收数字" blockGap=16
     ...
     */
    //% blockId=blockytalky_on_string block="BLE接收字符串" blockGap=16
